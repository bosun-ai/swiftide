...
/// A typed step in a [`Task`](crate::Task).
///
...
/// [`Task::register_node_fn`](crate::Task::register_node_fn), or
/// [`Task::register_node_async_fn`](crate::Task::register_node_async_fn) for async closures.
#[async_trait]
