...
impl CategoricalScoreV1 {
    pub fn new(string_value: String, id: String, trace_id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String) -> CategoricalScoreV1 {
        CategoricalScoreV1 {
            value: None,
            string_value,
            id,
