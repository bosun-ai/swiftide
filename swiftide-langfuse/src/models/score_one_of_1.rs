...
impl ScoreOneOf1 {
    pub fn new(string_value: String, id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String, data_type: DataType) -> ScoreOneOf1 {
        ScoreOneOf1 {
            value: None,
            string_value,
            id,
