...
impl NumericScoreV1 {
    pub fn new(value: f64, id: String, trace_id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String) -> NumericScoreV1 {
        NumericScoreV1 {
            value,
            id,
            trace_id,
