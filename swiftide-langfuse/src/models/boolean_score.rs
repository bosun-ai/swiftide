...
impl BooleanScore {
    pub fn new(value: f64, string_value: String, id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String) -> BooleanScore {
        BooleanScore {
            value,
            string_value,
            id,
