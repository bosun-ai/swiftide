...
impl GetScoresResponseDataOneOf {
    pub fn new(value: f64, id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String, data_type: DataType) -> GetScoresResponseDataOneOf {
