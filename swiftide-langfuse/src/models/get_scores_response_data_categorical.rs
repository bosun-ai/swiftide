...
impl GetScoresResponseDataCategorical {
    pub fn new(string_value: String, id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String) -> GetScoresResponseDataCategorical {
