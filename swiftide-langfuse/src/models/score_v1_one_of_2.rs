...
impl ScoreV1OneOf2 {
    pub fn new(value: f64, string_value: String, id: String, trace_id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String, data_type: DataType) -> ScoreV1OneOf2 {
        ScoreV1OneOf2 {
            value,
            string_value,
            id,
