...
impl GetScoresResponseDataOneOf2 {
    pub fn new(value: f64, string_value: String, id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String, data_type: DataType) -> GetScoresResponseDataOneOf2 {
