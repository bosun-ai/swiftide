...
impl ScoreV1OneOf {
    pub fn new(value: f64, id: String, trace_id: String, name: String, source: models::ScoreSource, timestamp: String, created_at: String, updated_at: String, data_type: DataType) -> ScoreV1OneOf {
        ScoreV1OneOf {
            value,
            id,
            trace_id,
